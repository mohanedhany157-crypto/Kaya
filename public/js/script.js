/**
 * ======================================================
 * JAVASCRIPT FOR KAYA STORE (PRE-ORDER + SUCCESS POPUP)
 * ======================================================
 */
...
function showSuccessModal(orderId) {
    // CSS Keyframes for "Squint" Animation (Happy Bounce/Squish)
    const style = document.createElement('style');
    style.innerHTML = `
        @keyframes mascot-squint {
            0%, 100% { transform: scale(1, 1); }
            45% { transform: scale(1, 1); }
            50% { transform: scale(1.1, 0.85) translateY(5px); } /* SQUISH */
            55% { transform: scale(0.95, 1.05) translateY(-5px); } /* STRETCH */
        ...
        .mascot-img {
            ...
            margin-bottom: 20px;
            /* Runs infinite to show "happiness" */
            animation: mascot-squint 3s ease-in-out infinite;
        }
        .success-backdrop {
    ...
    <div id="success-overlay" class="success-backdrop">
        <div style="background:#FEF6EC; padding:40px; border-radius:24px; text-align:center; max-width:500px; width:90%; border:4px solid #FD4D0A; box-shadow:0 25px 60px rgba(0,0,0,0.5);">
            ...
            <!-- MASCOT IMAGE (Squinting/Bouncing) -->
